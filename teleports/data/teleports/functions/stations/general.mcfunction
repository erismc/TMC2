...
execute if score $tphub tphub matches 2.. run summon area_effect_cloud ~3 ~1.7 ~3 {Particle:"block air",NoGravity:1b,Silent:1b,CustomNameVisible:1b,Radius:0f,Duration:21,CustomName:'{"text":"Warps","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'}
...
execute if score $tphub tphub matches 2.. positioned ~3 ~1.7 ~3 run function teleports:particles
