execute if score $tphub tphub matches 4.. run summon sheep ~3 ~301.0 ~3 {NoGravity:1b,Silent:1b,CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Health:1000f,Sheared:1b,Tags:["teleporter","stations"],ActiveEffects:[{Id:10b,Amplifier:10b,Duration:100000000,ShowParticles:0b},{Id:14b,Amplifier:0b,Duration:1000000000,ShowParticles:0b}],Attributes:[{Name:generic.max_health,Base:1000}]}
