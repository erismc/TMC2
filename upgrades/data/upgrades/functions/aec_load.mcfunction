...
execute positioned 212.5 135.3 -27.5 run summon area_effect_cloud ~ ~ ~ {NoGravity:1b,Silent:1b,CustomNameVisible:1b,Radius:0f,Duration:21,CustomName:'{"text":"Upgrade","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}'}