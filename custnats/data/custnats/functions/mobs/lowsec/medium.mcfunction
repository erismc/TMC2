execute if score $prng prngone matches 40.. run summon vex ~ ~-1 ~ {Silent:1b,DeathLootTable:"custnats:entities/empty",NoAI:1b,Health:1f,LifeTicks:2400,ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}]}
execute if score $prng prngone matches 9..39 run summon husk ~ ~ ~ {Health:12f,IsBaby:0b,CanBreakDoors:0b,Attributes:[{Name:generic.max_health,Base:12}]}
