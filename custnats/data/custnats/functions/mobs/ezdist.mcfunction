...
execute if predicate custnats:jungtemple run function custnats:mobs/jungtemple/easy
execute if predicate custnats:styx run function custnats:mobs/styx/easy
...
execute if predicate custnats:lobby run function custnats:mobs/lobby/easy
