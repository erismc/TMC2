...
execute if score $prng prngfour matches 21..24 unless score $thunder thundermole matches 1 unless score $prng prngtwo matches 1..18 run function area_fx:autumn/land/miniboss
