...
execute if score $intro ravagers matches 2 run summon ravager -47 31 354 {Tags:["intro_b","two"],PersistenceRequired:1b,ActiveEffects:[{Id:2b,Amplifier:1b,Duration:1000000,ShowParticles:0b},{Id:26b,Amplifier:12b,Duration:100000,ShowParticles:0b}],Attributes:[{Name:generic.attack_damage,Base:11}]}
