...
# execute if score $diff difftrack matches 3 unless data storage mole:checks temp.tag.upgrades run data merge entity @s {Health:9999,Invulnerable:1b,Age:-6000s}
